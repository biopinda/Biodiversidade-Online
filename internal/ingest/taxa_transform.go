...
func normalizeDistribution(rows []map[string]string) map[string]any {
	if len(rows) == 0 {
		return nil
	}
...
func normalizeVernacular(rows []map[string]string) []map[string]any {
	if len(rows) == 0 {
		return nil
	}
...
func normalizeSpeciesProfile(rows []map[string]string) map[string]any {
	if len(rows) == 0 {
		return nil
	}
	...
	return map[string]any{"lifeForm": inner}
}

// normalizeOthernames maps resourcerelationship rows to {taxonID, scientificName, taxonomicStatus}.
func normalizeOthernames(rows []map[string]string) []map[string]any {
	if len(rows) == 0 {
		return nil
	}
	out := make([]map[string]any, 0, len(rows))
...
func normalizeReference(rows []map[string]string) []map[string]any {
	if len(rows) == 0 {
		return nil
	}
	out := make([]map[string]any, 0, len(rows))
...
func normalizeTypes(rows []map[string]string) []map[string]any {
	if len(rows) == 0 {
		return nil
	}
	out := make([]map[string]any, 0, len(rows))
...
func enrichTaxonDoc(doc map[string]any, te *taxonExtensions) {
