...
**Structure Decision**: Option 2 (Web application) - Monorepo with packages/web/ (Astro frontend), packages/ingest/ (data ingestion), packages/transform/ (data transformation). Technical Context indicates web application with backend data processing and frontend Dashboard/ChatBB interfaces.
