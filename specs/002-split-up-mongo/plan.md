...
docker run -d --name chatbb-test \
  -p 4321:4321 \
  -e MONGO_URI="mongodb://dwc2json:REDACTED_PASSWORD@192.168.1.10:27017/?authSource=admin&authMechanism=DEFAULT" \
  -e MONGODB_URI_READONLY="mongodb://dwc2json:REDACTED_PASSWORD@192.168.1.10:27017/?authSource=admin&authMechanism=DEFAULT" \
  chatbb-refactored
